...
    file: "/LoveLetterZ/audio/suenan-como-tu.mp3",    
    duration: "3:34" 
  },

  { id: 2, title: "Miel ♡",           
    artist: "Valeria Jasso",        
    file: "/LoveLetterZ/audio/Miel.mp3",              
    duration: "3:22" 
  },
  
  { id: 3, title: "Mar",              
    artist: "Valeria Jasso",        
    file: "/LoveLetterZ/audio/Mar.mp3",               
    duration: "3:06" 
  },
  
  { id: 5, title: "K.",               
    artist: "Cigarettes After Sex", 
    file: "/LoveLetterZ/audio/K.mp3",             
    duration: "4:29" 
  },
  
  { id: 4, title: "Si tú supieras",     
    artist: "solamentedan",                     
    file: "/LoveLetterZ/audio/Si-tu-supieras.mp3",  
    duration: "3:27" 
  },

  { id: 5, title: "Ojos Color Sol",     
    artist: "Maullek",                     
    file: "/LoveLetterZ/audio/Ojos-Color-Sol.mp3",  
    duration: "3:17" 
  },

  { id: 6, title: "Te Quiero ",     
    artist: "Marlete Volz",                    
    file: "/LoveLetterZ/audio/te-quiero.mp3",  
    duration: "2:52" 
  },
];
...
const selectTrack = (i) => { 
  ...
  setTimeout(() => {
    if (audioRef.current) {
      audioRef.current.play().then(() => setPlaying(true)).catch(e => console.log("Error:", e));
    }
  }, 100);
};
...
      style={{ borderRadius: 16, overflow: "hidden", border: "none", background: "#100e0c", display: "flex", height: 340 }}>
    ...
    <audio 
      ...
      onTimeUpdate={() => {
        if (audioRef.current) {
          setProg((audioRef.current.currentTime / audioRef.current.duration) * 100 || 0);
        }
      }}
      onLoadedMetadata={() => {
        if (audioRef.current) {
...
const ITEMS = [
  ...
  "La forma en que recuerdas cosas pequeñas que terminan significando muchísimo",
  "La dulzura escondida en tu sarcasmo", 
  "Tu forma de querer, incluso cuando no la dices directamente", 
  "Me gusta que no te rindas fácil con las cosas que te importan."
];
      ...
      <div style={{ 
        ...
        {ITEMS.map((item, i) => (
          ...
          >
            ...
            <span style={{ 
              fontSize: 12, 
              color: checked.includes(i) ? "#8a7560" : "#3d2f1f", 
